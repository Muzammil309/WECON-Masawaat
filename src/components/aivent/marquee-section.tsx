...
export function MarqueeSection() {
  ...
  return (
    <section className="section-dark p-0 section-marquee" aria-label="section">
      {/* Clipping wrapper ensures perfectly rectangular strip */}
      <div className="marquee-clip">
        <div className="bg-color text-light d-flex lh-1 rot-2 marquee-strip">
      ...
      <div className="marquee-clip mt-min-20">
        <div className="bg-color-2 text-light d-flex lh-1 rot-min-1 marquee-strip">
