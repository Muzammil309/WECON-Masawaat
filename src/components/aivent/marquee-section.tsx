    ...
    <section id="section-marquee" className="section-dark p-0" aria-label="section">
      <div className="bg-color text-light d-flex py-4 lh-1 rot-2">
        <div className="de-marquee-list-1 wow fadeInLeft" data-wow-duration="3s">
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Next Intelligence</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Future Now</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Empowering Innovation</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Smarter Tomorrow</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Think Forward</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
          <span className="fs-60 mx-3" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>Cognitive Shift</span>
          <span className="fs-60 mx-3 op-2" style={{ fontSize: 'clamp(24px, 8vw, 60px)' }}>/</span>
        </div>
      </div>
