...
import { MyEventsContent } from '@/components/dashboard/attendee/my-events-content'
...
export default function MyEventsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      console.log('🔒 My Events: User not authenticated, redirecting to login')
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: '#0F1535', fontFamily: '"Plus Jakarta Display", sans-serif' }}>
      ...
      <div className="ml-[284px] p-[20px] relative z-10">
        <VisionTopbar title="My Events" breadcrumb="Events" />
        <MyEventsContent />
        <VisionFooter />
      </div>
    </div>
